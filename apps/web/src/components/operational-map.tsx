...
export function OperationalMap() {
  ...
  return <section className="operational-map" aria-labelledby="operational-map-title">
    <header className="operational-map-head"><div><p className="eyebrow">Peta operasional · Kalimantan Barat</p><h2 id="operational-map-title">15 titik referensi data uji</h2><p className="muted">AQI dan PM2.5 adalah nilai sintetis untuk demo lokal, bukan pemantauan atau prediksi resmi.</p></div><span className="badge tier-verify">{affected} titik terdampak</span></header>
